...
type SubmissionRepository interface {
	...
	FindByFormID(formID uint64) ([]models.Submission, error)
...
func (r *submissionRepository) FindByFormID(formID uint64) ([]models.Submission, error) {
	var submissions []models.Submission
	result := r.db.Where("form_id = ?", formID).Order("created_at DESC").Find(&submissions)
