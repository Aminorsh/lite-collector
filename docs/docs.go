                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.generateFormRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.generateFormResponse"
                        }
                    },
                    "400": {
                        "description": "请求参数错误",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.baseDataListResponse"
                        }
                    },
                    "401": {
                        "description": "未登录或 token 已过期",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.batchImportRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.baseDataItem"
                        }
                    },
                    "401": {
                        "description": "未登录或 token 已过期",
            ...
            "post": {
                ...
                "responses": {
                    "202": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/handlers.generateReportResponse"
                        }
                    },
                    "401": {
                        "description": "未登录或 token 已过期",
    ...
    "definitions": {
        ...
        "handlers.batchImportRequest": {
            ...
            "properties": {
                "rows": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.batchImportRow"
                    }
                }
            }
        },
        ...
        "handlers.generateFormRequest": {
            ...
            "properties": {
                "description": {
                    "type": "string",
                    "example": "员工信息登记表，包含姓名、年龄、部门、手机号、月薪"
                }
            }
        },
        "handlers.generateFormResponse": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string",
        ...
        "handlers.generateReportResponse": {
            "type": "object",
            "properties": {
                "job_id": {
                    "type": "integer",
                ...
                "message": {
                    "type": "string",
                    "example": "报告生成已排队，请通过 GET /api/v1/jobs/6 查询进度"
                }
            }
        },
